...
const FeatureCard = ({ icon, title, description }) => (
  <div className="w-[221px] h-[270px] relative bg-light rounded-[29px] shadow-md hover:shadow-lg transition-all duration-200">
  ...
  return (
    <div className="py-20 bg-secondary">
      ...
      <div className="flex items-center justify-center">
        <img 
          src="/child-cheerful-laughing-parent.png" 
          alt="Happy family" 
